...
class Settings(BaseSettings):
    ...
    DEEPSEEK_SUPPORTED_MODELS: str = "deepseek-chat,deepseek-reasoner"
    ...
    # 阿里云配置
    ALIYUN_API_KEY: str = ""
    ALIYUN_API_URL: str = "https://dashscope.aliyuncs.com/api/v1/services/aigc/text-generation/generation"
    ...
    def PROVIDER_SUPPORTED_MODELS(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "deepseek": [model.strip() for model in self.DEEPSEEK_SUPPORTED_MODELS.split(",")]
        }
