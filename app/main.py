...
async def lifespan(app: FastAPI):
    ...
    logger.info(f"服务监听地址: http://service.scitiger.cn/text-service/")
    logger.info(f"API测试路由: http://service.scitiger.cn/text-service/api/test/")
    logger.info(f"健康检查路由: http://service.scitiger.cn/text-service{settings.API_V1_STR}/health/")
    logger.info(f"任务创建路由: http://service.scitiger.cn/text-service{settings.API_V1_STR}/tasks/")
