...
def process_text_task(self, task_id: str, model: str, provider_name: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
    """
    处理文本模型调用任务
    ...
    Returns:
        Dict[str, Any]: 任务结果
    """
    logger.info(f"Processing text task {task_id} with model {model} and provider {provider_name}")
